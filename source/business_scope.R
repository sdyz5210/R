...
myfile<-read.csv(file.choose(),header=TRUE,colClasses=c("NULL", "NULL","NULL","NULL","NULL","NULL","NULL", "character","NULL","NULL","NULL"))
#myile<-read.table(file.choose(),header=TRUE,sep=",",colClasses=c("NULL", "NULL","NULL","NULL","NULL","NULL","NULL", "business_scope","NULL","NULL","NULL"))
...
write.csv(myfile.freq2, file = "/Users/mac/Downloads/beihang/scope.txt", row.names = F, quote = F,fileEncoding="UTF-8")
